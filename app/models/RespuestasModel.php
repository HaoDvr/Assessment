...
class RespuestasModelo
{
    ...
    {
        // Cambiamos 'valor_sub_nivel' por 'sub_valor' en la lista de campos
        $stmt = Conexion::conectar()->prepare("INSERT INTO $tabla (
            ...
            omitida, usuario_reasignado, motivo_omision, sub_valor
        ) VALUES (
            :token, :id_u, :id_p, :p_txt, :id_r, :r_txt, :valor, :libre,
            :detallada, :clasif, :nom_u, :entre_js, :omit, :u_reasig, :motivo, :v_sub
        )");
        ...
        $stmt->bindParam(":valor",      $datos["valor_respuesta"], PDO::PARAM_STR);
        ...
        $stmt->bindParam(":entre_js",   $datos["entrevistados_json"], PDO::PARAM_STR);
        $stmt->bindParam(":omit",       $datos["omitida"], PDO::PARAM_STR);
        $stmt->bindParam(":u_reasig",   $datos["usuario_reasignado"], PDO::PARAM_STR);
        $stmt->bindParam(":motivo",     $datos["motivo_omision"], PDO::PARAM_STR);

        // Mapeamos el dato al marcador :v_sub
        $stmt->bindParam(":v_sub",      $datos["sub_valor"], PDO::PARAM_STR);
